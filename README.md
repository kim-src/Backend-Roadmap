...
### <p align = "center">HTTP, 이제 머릿속 깊은 곳에 입력시켜 드리겠습니다.</p>
...
Hypertext가 아닌 text로만 구성된 모니터 화면아래 이미지의 모습은 당시 나우누리

hypertext가 아닌 text
그렇다면 HTTP가 없었거나 막 출시됐던 시기의 인터넷 환경은 어떤 모습이었을까요?
...
따라서 90년대 당시 세상에 태어나신 분들(필자 포함)은 과거 인터넷 환경을 상상하기 어려울 것입니다.
그러므로 90년대 출생한 분들(필자 포함)은 HTTP 이전 환경을 상상하기 어려울 것입니다.

그렇다면 기존의 Text 인터넷 환경은 어떤 모습이었을까요?
